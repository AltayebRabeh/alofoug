                            ...
                            <div class="card-body">
                                <form class="form" action="{{ route('pages.store') }}" method="POST">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            <label for="content">محتوي الصفحة بالعربي</label>
                                            <textarea id="content" rows="5" class="form-control" name="content" placeholder="الصفحة">{{ old('content') }}</textarea>
                                            @error('content')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="content_en">محتوي الصفحة بالانجليزي</label>
                                            <textarea id="content_en" rows="5" class="form-control" name="content_en" placeholder="الصفحة">{{ old('content_en') }}</textarea>
                                            @error('content_en')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
...
<script>
    ...
    $('#removeThumbnail').click(function() {
      ...
      $('#content').summernote({
        placeholder: 'محتوي الصفحة بالعربي',
        tabsize: 2,
        height: 200,
        lang: 'ar-AR',
        toolbar: [
      ...
      $('#content_en').summernote({
        placeholder: 'محتوي الصفحة بالانجليزي',
        tabsize: 2,
        height: 200,
        lang: 'ar-AR',
        toolbar: [
