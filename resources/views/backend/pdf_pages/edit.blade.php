                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body">
                                <form class="form" action="{{ route('pdf.pages.update', $pdfPage) }}" method="POST">
                                    @csrf
                                    <div class="form-body">
                                        <div class="form-group">
                                            <label for="name">إسم الصفحة بالعربي</label>
                                            <input type="text" id="name" class="form-control" value="{{ old('name', $pdfPage->name) }}" placeholder="إسم الصفحة بالعربي" name="name">
                                            @error('name')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="name_en" class="form-control" value="{{ old('name_en', $pdfPage->getTranslation('name', 'en')) }}" placeholder="إسم الصفحة بالانجليزي" name="name_en">
                                            @error('name_en')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input id="pdf" readonly class="form-control" value="{{ old('pdf', $pdfPage->pdf) }}" type="text" name="pdf">
                                            </div>
                                            @error('pdf')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input id="pdf_en" readonly class="form-control" value="{{ old('pdf_en', $pdfPage->getTranslation('pdf', 'en')) }}" type="text" name="pdf_en">
                                            </div>
                                            @error('pdf_en')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
