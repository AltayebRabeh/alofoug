                                ...
                                <form class="form" action="{{ route('categories.store') }}" method="POST">
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-6 col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="name" class="form-control" value="{{ old('name') }}" placeholder="الاسم بالعربي" name="name">
                                                    @error('name')
                                            ...
                                            <div class="col-md-6 col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="name_en" class="form-control " value="{{ old('name_en') }}" placeholder="الاسم بالانجليزي" name="name_en">
                                                    @error('name_en')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="description" rows="5" class="form-control" name="description" placeholder="الوصف"> {{ old('description') }}</textarea>
                                            @error('description')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
