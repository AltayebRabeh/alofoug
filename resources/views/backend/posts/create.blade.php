                                ...
                                <form class="form" action="{{ route('posts.store') }}" method="POST">
                                    ...
                                    <div class="form-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="title" class="form-control" value="{{ old('title') }}" placeholder="عنوان الحدث | الخبر بالعربي" name="title">
                                            @error('title')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="title_en" class="form-control" value="{{ old('title_en') }}" placeholder="عنوان الحدث | الخبر بالانجليزي" name="title_en">
                                            @error('title_en')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="content" rows="5" class="form-control" name="content" placeholder="تفاصيل الحدث | الخبر"> {{ old('content') }}</textarea>
                                            @error('content')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="content_en" rows="5" class="form-control" name="content_en" placeholder="تفاصيل الحدث | الخبر">{{ old('content_en') }}</textarea>
                                            @error('content_en')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input id="thumbnail" readonly class="form-control" type="text" name="thumbnail">
                                        ...
                                        <div class="form-group mt-1">
                                            <input type="checkbox" name="breaking_news" @checked(old('breaking_news')) id="switcherySize1" class="switchery" data-switchery="true">
