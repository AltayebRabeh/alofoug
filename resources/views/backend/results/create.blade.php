                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title cairo" id="basic-layout-form">إضافة نتيجة</h4>
                                ...
                                <form class="form" action="{{ route('results.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="description_en" rows="5" class="form-control" name="description_en"> {{ old('description_en') }}</textarea>
