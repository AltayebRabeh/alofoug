                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-name cairo" id="basic-layout-form">تعديل برنامج</h4>
                        ...
                        <div class="card-description collapse show">
                            <div class="card-body">
                                <form class="form" action="{{ route('programs.update', $program) }}" method="POST">
                                    @csrf
                                    <div class="form-body">

                                        <div class="form-group">
                                            <label for="name">إسم البرنامج بالعربي</label>
                                            <input type="text" id="name" class="form-control" value="{{ old('name', $program->name) }}" placeholder="إسم البرنامج بالعربي" name="name">
                                            @error('name')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="name_en" class="form-control" value="{{ old('name_en', $program->getTranslation('name', 'en')) }}" placeholder="إسم البرنامج بالانجليزي" name="name_en">
                                            @error('name_en')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="description" rows="5" class="form-control" name="description" placeholder="وصف البرنامج"> {{ old('description', $program->description) }}</textarea>
                                            @error('description')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="description_en" rows="5" class="form-control" name="description_en" placeholder="وصف البرنامج">{{ old('description_en', $program->getTranslation('description', 'en')) }}</textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="select2 form-control" id="classrooms" multiple="multiple" name="classrooms[]">
                                                @foreach ($classrooms as $classroom)
                                                    <option value="{{ $classroom->id }}" {{ in_array($classroom->id, $program->classrooms->modelKeys()) ? 'selected' : '' }}>{{ $classroom->name }}</option>
                                                @endforeach
                                            </select>
                                            @error('classrooms')
                                                <span class="text-danger">{{ $message }}</span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input id="image" readonly class="form-control" type="text" value="{{ $program->image }}" name="image">
                                                <a href="javascript:void()" id="removeImage" class="btn btn-danger"><i class="la la-trash"></i></a>
                                            </div>
                                            <div id="holder" style="margin-top:15px">
                                                <img src="{{ $program->image }}" style="height: 5rem;">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="url" id="e_learning_url" class="form-control" value="{{ old('e_learning_url', $program->e_learning_url) }}" placeholder="رابط التعليم الالكتروني" name="e_learning_url">
